...
# Generate icons
convert "$input_image" -resize "20x20!" "${output_dir}/Icon-App-20x20@1x.png"
...
convert "$input_image" -resize "29x29!" "${output_dir}/Icon-App-29x29@1x.png"
...
convert "$input_image" -resize "40x40!" "${output_dir}/Icon-App-40x40@1x.png"
...
convert "$input_image" -resize "76x76!" "${output_dir}/Icon-App-76x76@1x.png"
...
convert "$input_image" -resize "1024x1024!" "${output_dir}/Icon-App-1024x1024@1x.png"
